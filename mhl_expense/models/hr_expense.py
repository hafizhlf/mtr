...
class HrExpenseSheetInherit(models.Model):    
    ...
    bank_journal_id = fields.Many2one('account.journal', string='Bank Journal', states={'done': [('readonly', True)], 'post': [('readonly', True)]}, check_company=True, domain="[ ('company_id', '=', company_id),'|',('type', 'in', ['cash', 'bank']),('is_report_cash_advance', '=', True),]",
